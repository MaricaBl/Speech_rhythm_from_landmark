The present project's aim is to derive speech rhythm metrics directly from speech samples. In doing so a specialized software based on acoustic landmarks was used. 
